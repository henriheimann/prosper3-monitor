...
export const loginUserGetTokenSuccess = createAction(
  '[Auth] Login User Get Token Success',
...
export const logoutUserFailure = createAction('[Auth] Logout User Failure', props<{ error: HttpErrorResponse }>());

export const requestUnauthorized = createAction('[Auth] Request Unauthorized');
