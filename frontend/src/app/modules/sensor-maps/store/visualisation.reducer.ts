...
export const reducer = createReducer(
  ...
  on(VisualisationsActions.startIdentifyingDevice, (state) => {
    return {
      ...state,
      inIdentifyingMode: true
    };
  }),

  on(VisualisationsActions.stopIdentifyingDevice, (state) => {
    return {
      ...state,
      inIdentifyingMode: false
    };
  ...
  on(VisualisationsActions.deviceIdentified, (state, action) => {
    return {
      ...state,
      inIdentifyingMode: false,
      selectedDevice: action.device
