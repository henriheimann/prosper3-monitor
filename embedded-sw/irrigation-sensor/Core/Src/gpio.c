...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(RFM95_NRST_GPIO_Port, RFM95_NRST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, RFM95_NSS_Pin|I2C_ENABLE_Pin, GPIO_PIN_SET);
  ...
  GPIO_InitStruct.Pin = RFM95_NRST_Pin|RFM95_NSS_Pin|I2C_ENABLE_Pin;
  ...
  GPIO_InitStruct.Pin = RFM95_DIO0_Pin|RFM95_DIO1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
